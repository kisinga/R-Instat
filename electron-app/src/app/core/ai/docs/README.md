# Dialog AI Foundation Docs

This documentation set defines how the dialog platform scales to 200+ dialogs with parity and AI integration.

## Ownership

- Architecture docs: Staff/Senior engineers (core platform owners)
- Migration docs: Feature engineers migrating dialog families
- AI integration docs: AI platform owners
- Operations docs: QA and release managers
